...
import { categories as defaultCategories, type DocumentCategory, type DocumentItem } from "@/lib/mock-data";
import { FileText } from "lucide-react";
import { categoryService, documentService } from "@/services/api";
...
const Index = () => {
  ...
  useEffect(() => {
    documentService.list(true).then(setDocs).catch(() => setDocs([]));
    categoryService
      .list()
      .then((rows) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 space-y-6">
        ...
        <CategoryFilter selected={category} onSelect={setCategory} categories={cats} />
